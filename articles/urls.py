...
urlpatterns = [
    ...
    path('pdf/<str:archive>/<str:arxiv_id>', views.pdf, name='pdf_with_archive'),
    path('pdf/<str:arxiv_id>', views.pdf, name='pdf'),
    ...
    path('abs/<path:arxiv_id>', views.abstract, name='abstract'),
    ...
    path('format/<str:archive>/<str:arxiv_id>', views.format_view, name='format_with_archive'),
    path('format/<str:arxiv_id>', views.format_view, name='format'),
