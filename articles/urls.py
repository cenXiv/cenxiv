...
urlpatterns = [
    ...
    path('cn-pdf/<str:archive>/<str:arxiv_id>', cache_page(60 * 5)(views.cn_pdf), name='cn_pdf_with_archive'),
    path('cn-pdf/<str:arxiv_id>', cache_page(60 * 5)(views.cn_pdf), name='cn_pdf'),
